...
public class Pruebas {
	...
	public static void main(String[] args) throws ParseException {
		...
		Predicate p1 = cb.equal(from2.get("nombre"), "Bart");
		Predicate p2 = cb.equal(from2.get("direccion").get("ciudad"), "Salamanca"); //nada de direccion.ciudad
		...
		*/
		...
		//select c from Cliente c join c.pedidos p where p.fecha>01/09/2018
		cq5.where(p5);
