...
public class Pruebas_Metamodel {
	...
	public static void main(String[] args) {
		...
		Predicate p1 = cb.equal(root2.get(Cliente_.DIRECCION).get(Direccion_.CIUDAD), "Salamanca"); //nada de direccion.ciudad
		Predicate p2 = cb.equal(root2.get(Cliente_.NOMBRE), "Bart");
